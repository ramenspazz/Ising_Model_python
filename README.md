...
> C++20 > Python... remade this in C++ and its almost two orders of magnitude faster. Whomever said I needed to use python for this as it is industry standard and all that jazz doesnt know what they are talking about... Time spent > all else. I did spend many hours profiling and optomizing the crap out of this and even rewrote a few things from scratch, so I am confident this is the fastest this can run short of a entire rewrite.
