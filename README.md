...
# OSX...
You might be able to run all this in the terminal, but my fiend using OSX siera could not get it to run due to weird permissions issues with read and write to sys.stdout or sys.stderr which is really dumb...
